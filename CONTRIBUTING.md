...
This guide is adapted from the [opensource.guides Contributing document](https://github.com/github/opensource.guide/blob/master/CONTRIBUTING.md)

# Contributing to Candy tracking project

Thanks for checking out the Candy tracking project! We're excited to hear and learn from you. Your experiences will benefit others who read and use these guides.
...
* Candy tracking project are released with a [Contributor Code of Conduct](./CODE_OF_CONDUCT.md). By participating in this project, you agree to abide by its terms.
